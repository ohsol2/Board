...
<body>
	...
	<div class="tablebox">
		<form id="writeForm" action="WriteServlet" method="post"  enctype="multipart/form-data">
			<input type="hidden" name="id" value="<%=id%>">
			<input type="hidden" name="command" value="write">
			<%if(id==null){ %>
				<h1>로그인 후 접근가능한 페이지 입니다.</h1>
			<%}else{ %>
			...
			<table style="margin: 20px auto; width:1000px;">
				...
				<tr>
					...
					<td><input class="titleinput" type="text" name="title" required></td>
				</tr>
				<tr>
			...
			<input class="writing" id="submitBtn" type="submit" value="작성완료"/>
			<%} %>
		</form>
	</div>
